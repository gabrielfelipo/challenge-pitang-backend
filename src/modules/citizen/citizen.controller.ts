...
import { CreateCitizenDto, createCitizenSchema } from './dtos/create-citizen.dto';
...
export class CitizenController {
  ...
  @Post()
  async createCitizen(
    @Body(new ZodValidationPipe(createCitizenSchema))  createCitizenDto: CreateCitizenDto
  ) {
